...
from lib.remote import zhibo8


def get_living_matches():
    matches = zhibo8.get_living_matches()
...
def main_loop():
    ...
    while True:
        match_max_sid = zhibo8.get_match_max_sid(match.id)
        ...
        text_livings = zhibo8.get_match_living(match.id, current_match_max_sid)
